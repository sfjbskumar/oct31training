...
class PensionServiceTest{
    ...
    void testsave(){
        ...
        p.setAge(21);
        p.setBalance(10000);
        p.setMobile("98765432");
        p.setEmpStatus("A");
        p.setPensionStatus("N");
        p.setPensionMMYY("03/2022");
