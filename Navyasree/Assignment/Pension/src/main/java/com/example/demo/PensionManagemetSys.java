...
public class PensionManagemetSys {
   ...
   private  Integer balanceamount ;
    ...
    public PensionManagemetSys(int id, String name, String age, Integer balanceamount, Integer phone, String empstatus, String pensionstatus, String pensionmmyy, int installment) {
        this.id = id;
        this.name = name;
        this.age = age;
