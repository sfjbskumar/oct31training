...
import org.springframework.boot.autoconfigure.domain.EntityScan;
    ...
    public class Pensionclass {
        ...
        public Pensionclass(int id, String name, String age, Integer balance_amount, Integer phone, String empstatus, String pensionStatus, String pensionmmyyy, float installment) {
            this.id = id;
            this.name = name;
            this.age = age;
            this.balance_amount = balance_amount;
