...
import com.ahmed.PensionManagementSystem.repository.PensionRepository;
import com.ahmed.PensionManagementSystem.service.PensionService;
...
@WebMvcTest(PensionControllerTest.class)
class PensionControllerTest {
    ...
    void testCreateApplicant() throws Exception{
        ...
        Mockito.when(pensionService.save(Mockito.any(Pension.class)));
