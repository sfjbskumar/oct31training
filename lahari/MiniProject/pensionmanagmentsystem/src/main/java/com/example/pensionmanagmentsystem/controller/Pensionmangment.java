...
public class Pensionmangment {
    ...
    public Pensionmangment(int id, String name, String age, Integer balance_amount, Integer phone, String empstatus, String pensionStatus, String pensionmmyyy, float installment) {
        this.id = id;
        this.name = name;
        this.age = age;
        this.balance_amount = balance_amount;
...
>>>>>>> c8dc71d1090738cf01f2af5f2b6df36bcfc53031
