...
import com.example.pensionManagementSystem.model.pensionController;
...
class PensionControllerTest {
    ...
    void testCreateApplicant() throws Exception{
        ...
        Mockito.when(pensionService.save(Mockito.any(Pension.class))).thenReturn(String.valueOf(pension));
